...
def compute_predictions_logits(
    ...
    for (example_index, example) in enumerate(all_examples):
        ...
        if version_2_with_negative:
            ...
            if len(nbest) == 1:
                nbest.insert(0, _NbestPrediction(text="empty", start_logit=0.0, end_logit=0.0, start_prob=0.0, end_prob=0.0))
        ...
        for idx, entry in enumerate(nbest):
            ...
            if not best_non_null_entry:
                if entry.text:
                    ...
                    best_non_null_index = idx
            if not best_null_index:
                if not entry.text:
                    best_null_index = idx
        ...
        if not version_2_with_negative:
            ...
            if score_diff > null_score_diff_threshold:
                ...
                all_probs[example.qas_id] = best_prob_null
            else:
                all_predictions[example.qas_id] = best_non_null_entry.text
                all_probs[example.qas_id] = best_prob_non_null
