...
class BertQA(nn.Module):
    ...
    def __init__(self, config_class, model_class, model_type='bert-base-uncased', do_cls=True):
        super().__init__()
        self.do_cls = do_cls
        self.config = config_class.from_pretrained(model_type, output_hidden_states=do_cls)
        self.model = model_class.from_pretrained(model_type, config=self.config)
